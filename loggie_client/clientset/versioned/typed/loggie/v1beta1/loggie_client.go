...
import (
	...
	"code.eoitek.net/monitor/dc/k8s-crd/loggie_client/clientset/versioned/scheme"
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*LoggieV1beta1Client, error) {
	...
	return &LoggieV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new LoggieV1beta1Client for the given config and
